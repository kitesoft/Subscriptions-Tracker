// Same as [UserAccountsDrawerHeader] with few adjustments
  ...
  void performLayout(Size size) {
    ...
    if (bottomLine != null) {
      final Size constraintSize =
          iconSize == null ? size : size - new Offset(iconSize.width, 0.0);
      ...
      final Size bottomLineSize =
          layoutChild(bottomLine, new BoxConstraints.loose(constraintSize));
      ...
      if (bottomLine == accountEmail && hasChild(accountName)) {
        final Size nameSize =
            layoutChild(accountName, new BoxConstraints.loose(constraintSize));
        positionChild(
...
class AuthDrawerHeader extends StatefulWidget {
  ...
  @override
  _AuthDrawerHeaderState createState() => new _AuthDrawerHeaderState();
}

class _AuthDrawerHeaderState extends State<AuthDrawerHeader> {
  bool _isOpen = false;
